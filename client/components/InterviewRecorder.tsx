...
export default function InterviewRecorder({ attemptId, interviewId, enabled = true, muted = false, captureScreen = false }: Props & { muted?: boolean; captureScreen?: boolean }) {
